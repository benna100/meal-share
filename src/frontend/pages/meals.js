//Created function and rendering and return that one
function showAllMeals(meals){
  
  return meals.map((meal) => {
    return`

    <li><img src="/images/${meal.title}.jpg" alt="Meal title">
    <h5>${meal.title}</h5>
    ...
    <div class="container">
      <div class="banner-content">
        ...
        <div class="botton-actions">
          <a href="createMeal"><button class="btn btn-primary" data-navigo>Create your Meal</button></a>
        </div>
      </div>
    </div>
  </div>
